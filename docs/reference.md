...
| Value.parse | string &rarr; value | "parse s" parses a string representation into a value. |
| Value.print | value &rarr; string | "print v" converts a value to its compact string representation. |
