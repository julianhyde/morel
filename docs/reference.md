...
| [Core](lib/core.md) | The compiler's tree, as a value.<br>[`ty`](lib/core.md#ty-impl), [`pat`](lib/core.md#pat-impl), [`join_kind`](lib/core.md#join_kind-impl), [`exp`](lib/core.md#exp-impl), [`print`](lib/core.md#print-impl), [`typeOf`](lib/core.md#typeOf-impl), [`printType`](lib/core.md#printType-impl) |
...
| [Plan](lib/plan.md) | What the compiler made of a function.<br>[`bodyOf`](lib/plan.md#bodyOf-impl), [`program`](lib/plan.md#program-impl) |
