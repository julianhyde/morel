...
| [Spark](lib/spark.md) | Connections to Apache Spark.<br>[`connection`](lib/spark.md#connection-impl), [`Spark`](lib/spark.md#Spark-impl), [`connect`](lib/spark.md#connect-impl), [`connectDefault`](lib/spark.md#connectDefault-impl), [`catalog`](lib/spark.md#catalog-impl), [`close`](lib/spark.md#close-impl), [`using`](lib/spark.md#using-impl) |
