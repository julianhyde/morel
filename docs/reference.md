...
| [Decimal](lib/decimal.md) | Exact decimal numbers with 34 significant digits.<br>[`decimal`](lib/decimal.md#decimal-impl), [`radix`](lib/decimal.md#radix-impl), [`precision`](lib/decimal.md#precision-impl), [`maxFinite`](lib/decimal.md#maxFinite-impl), [`minPos`](lib/decimal.md#minPos-impl), [`+`](lib/decimal.md#+-impl), [`-`](lib/decimal.md#--impl), [`*`](lib/decimal.md#*-impl), [`/`](lib/decimal.md#/-impl), [`rem`](lib/decimal.md#rem-impl), [`~`](lib/decimal.md#~-impl), [`abs`](lib/decimal.md#abs-impl), [`min`](lib/decimal.md#min-impl), [`max`](lib/decimal.md#max-impl), [`sign`](lib/decimal.md#sign-impl), [`compare`](lib/decimal.md#compare-impl), [`<`](lib/decimal.md#<-impl), [`<=`](lib/decimal.md#<=-impl), [`>`](lib/decimal.md#>-impl), [`>=`](lib/decimal.md#>=-impl), [`realFloor`](lib/decimal.md#realFloor-impl), [`realCeil`](lib/decimal.md#realCeil-impl), [`realTrunc`](lib/decimal.md#realTrunc-impl), [`realRound`](lib/decimal.md#realRound-impl), [`floor`](lib/decimal.md#floor-impl), [`ceil`](lib/decimal.md#ceil-impl), [`trunc`](lib/decimal.md#trunc-impl), [`round`](lib/decimal.md#round-impl), [`fromInt`](lib/decimal.md#fromInt-impl), [`fromReal`](lib/decimal.md#fromReal-impl), [`toReal`](lib/decimal.md#toReal-impl), [`toString`](lib/decimal.md#toString-impl), [`fromString`](lib/decimal.md#fromString-impl), [`fmt`](lib/decimal.md#fmt-impl) |
...
| [IEEEReal](lib/ieee-real.md) | IEEE 754 floating-point definitions.<br>[`Unordered`](lib/ieee-real.md#Unordered-impl) |
...
| [Interact](lib/interact.md) | Interactive session utilities.<br>[`Error`](lib/interact.md#Error-impl), [`EvalOnly`](lib/interact.md#EvalOnly-impl), [`use`](lib/interact.md#use-impl), [`useSilently`](lib/interact.md#useSilently-impl) |
...
| [Word](lib/word.md) | Unsigned-integer (word) operations.<br>[`word`](lib/word.md#word-impl), [`wordSize`](lib/word.md#wordSize-impl), [`toLarge`](lib/word.md#toLarge-impl), [`toLargeX`](lib/word.md#toLargeX-impl), [`toLargeWord`](lib/word.md#toLargeWord-impl), [`toLargeWordX`](lib/word.md#toLargeWordX-impl), [`fromLarge`](lib/word.md#fromLarge-impl), [`fromLargeWord`](lib/word.md#fromLargeWord-impl), [`toLargeInt`](lib/word.md#toLargeInt-impl), [`toLargeIntX`](lib/word.md#toLargeIntX-impl), [`fromLargeInt`](lib/word.md#fromLargeInt-impl), [`toInt`](lib/word.md#toInt-impl), [`toIntX`](lib/word.md#toIntX-impl), [`fromInt`](lib/word.md#fromInt-impl), [`andb`](lib/word.md#andb-impl), [`orb`](lib/word.md#orb-impl), [`xorb`](lib/word.md#xorb-impl), [`notb`](lib/word.md#notb-impl), [`<<`](lib/word.md#<<-impl), [`>>`](lib/word.md#>>-impl), [`~>>`](lib/word.md#~>>-impl), [`+`](lib/word.md#+-impl), [`-`](lib/word.md#--impl), [`*`](lib/word.md#*-impl), [`div`](lib/word.md#div-impl), [`mod`](lib/word.md#mod-impl), [`compare`](lib/word.md#compare-impl), [`<`](lib/word.md#<-impl), [`<=`](lib/word.md#<=-impl), [`>`](lib/word.md#>-impl), [`>=`](lib/word.md#>=-impl), [`~`](lib/word.md#~-impl), [`min`](lib/word.md#min-impl), [`max`](lib/word.md#max-impl), [`fmt`](lib/word.md#fmt-impl), [`toString`](lib/word.md#toString-impl), [`scan`](lib/word.md#scan-impl), [`fromString`](lib/word.md#fromString-impl) |
