...
| [Range](lib/range.md) | Operations on ranges of ordered values.<br>[`range`](lib/range.md#range-impl), [`isMember`](lib/range.md#isMember-impl), [`normalize`](lib/range.md#normalize-impl), [`toBag`](lib/range.md#toBag-impl), [`toList`](lib/range.md#toList-impl) |
