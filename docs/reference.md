...
| [Core](lib/core.md) | Reified Morel core expressions.<br>[`expr`](lib/core.md#expr-impl), [`pat`](lib/core.md#pat-impl) |
...
| [Plan](lib/plan.md) | Reify, optimize, and run Morel expressions.<br>[`core`](lib/plan.md#core-impl), [`expr_type`](lib/plan.md#expr_type-impl), [`optimize`](lib/plan.md#optimize-impl), [`row_type`](lib/plan.md#row_type-impl), [`transform`](lib/plan.md#transform-impl) |
| [Range](lib/range.md) | Operations on ranges of ordered values.<br>[`continuous_set`](lib/range.md#continuous_set-impl), [`discrete_set`](lib/range.md#discrete_set-impl), [`range`](lib/range.md#range-impl), [`complement`](lib/range.md#complement-impl), [`contains`](lib/range.md#contains-impl), [`continuousSetOf`](lib/range.md#continuousSetOf-impl), [`discreteSetOf`](lib/range.md#discreteSetOf-impl), [`ranges`](lib/range.md#ranges-impl), [`toBag`](lib/range.md#toBag-impl), [`toList`](lib/range.md#toList-impl) |
...
| [Type](lib/type.md) | Reified Morel types.<br>[`t`](lib/type.md#t-impl) |
