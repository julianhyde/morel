...
| [Interact](lib/interact.md) | Interactive session utilities.<br>[`Error`](lib/interact.md#Error-impl), [`use`](lib/interact.md#use-impl), [`useSilently`](lib/interact.md#useSilently-impl) |
