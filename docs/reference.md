...
| [Plan](lib/plan.md) | Reify, optimize, and run Morel expressions.<br>[`core`](lib/plan.md#core-impl), [`optimize`](lib/plan.md#optimize-impl), [`transform`](lib/plan.md#transform-impl) |
