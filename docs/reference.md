...
| [Int](lib/int.md) | Fixed-precision integer operations.<br>[`int`](lib/int.md#int-impl), [`toLarge`](lib/int.md#toLarge-impl), [`fromLarge`](lib/int.md#fromLarge-impl), [`toInt`](lib/int.md#toInt-impl), [`fromInt`](lib/int.md#fromInt-impl), [`precision`](lib/int.md#precision-impl), [`minInt`](lib/int.md#minInt-impl), [`maxInt`](lib/int.md#maxInt-impl), [`div`](lib/int.md#div-impl), [`mod`](lib/int.md#mod-impl), [`quot`](lib/int.md#quot-impl), [`rem`](lib/int.md#rem-impl), [`compare`](lib/int.md#compare-impl), [`abs`](lib/int.md#abs-impl), [`min`](lib/int.md#min-impl), [`max`](lib/int.md#max-impl), [`sign`](lib/int.md#sign-impl), [`sameSign`](lib/int.md#sameSign-impl), [`fmt`](lib/int.md#fmt-impl), [`toString`](lib/int.md#toString-impl), [`fromString`](lib/int.md#fromString-impl) |
...
| stringFold           | int    | 0       | In tabular mode, the column width at which long strings are folded across multiple lines. 0 disables folding. |
