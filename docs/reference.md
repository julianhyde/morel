...
| [Relational](lib/relational.md) | Relational algebra operations for Morel queries.<br>[`descending`](lib/relational.md#descending-impl), [`ordered`](lib/relational.md#ordered-impl), [`unordered`](lib/relational.md#unordered-impl), [`compare`](lib/relational.md#compare-impl), [`count`](lib/relational.md#count-impl), [`empty`](lib/relational.md#empty-impl), [`iterate`](lib/relational.md#iterate-impl), [`max`](lib/relational.md#max-impl), [`min`](lib/relational.md#min-impl), [`nonEmpty`](lib/relational.md#nonEmpty-impl), [`only`](lib/relational.md#only-impl), [`sum`](lib/relational.md#sum-impl) |
...
| [Table](lib/table.md) | Measures and context-dependent calculations.<br>[`measure`](lib/table.md#measure-impl), [`cx`](lib/table.md#cx-impl), [`table`](lib/table.md#table-impl), [`measure_fn`](lib/table.md#measure_fn-impl), [`evaluate`](lib/table.md#evaluate-impl), [`eval`](lib/table.md#eval-impl), [`restrict`](lib/table.md#restrict-impl), [`restrict_anon`](lib/table.md#restrict_anon-impl), [`relax`](lib/table.md#relax-impl), [`override`](lib/table.md#override-impl), [`test`](lib/table.md#test-impl), [`paramOf`](lib/table.md#paramOf-impl), [`toString`](lib/table.md#toString-impl), [`orderedTable`](lib/table.md#orderedTable-impl), [`elements`](lib/table.md#elements-impl), [`param`](lib/table.md#param-impl) |
