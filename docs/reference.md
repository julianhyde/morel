...
| [Table](lib/table.md) | Measures and context-dependent calculations.<br>[`measure`](lib/table.md#measure-impl), [`context`](lib/table.md#context-impl), [`table`](lib/table.md#table-impl), [`measure_fn`](lib/table.md#measure_fn-impl), [`evaluate`](lib/table.md#evaluate-impl), [`eval`](lib/table.md#eval-impl), [`restrict`](lib/table.md#restrict-impl), [`restrict_anon`](lib/table.md#restrict_anon-impl), [`relax`](lib/table.md#relax-impl), [`override`](lib/table.md#override-impl), [`test`](lib/table.md#test-impl), [`paramOf`](lib/table.md#paramOf-impl), [`toString`](lib/table.md#toString-impl), [`elements`](lib/table.md#elements-impl), [`param`](lib/table.md#param-impl) |
