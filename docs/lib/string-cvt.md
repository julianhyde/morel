...
datatype <a id='realfmt' href="#realfmt-impl">realfmt</a> = SCI of int option | FIX of int option | GEN of int option | EXACT
</pre>

<a id="radix-impl"></a>
<h3><code><strong>datatype</strong> radix = BIN | OCT | DEC | HEX</code></h3>

specifies the numeric base: binary (2), octal (8), decimal (10), or
hexadecimal (16).

<a id="reader-impl"></a>
<h3><code><strong>type</strong> ('a, 'b) reader = 'b -> ('a * 'b) option</code></h3>
...
<a id="realfmt-impl"></a>
<h3><code><strong>datatype</strong> realfmt = SCI of int option | FIX of int option | GEN of int option | EXACT</code></h3>
