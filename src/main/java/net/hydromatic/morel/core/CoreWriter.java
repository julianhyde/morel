...
/** Context for writing a Core node as a string. */
public class CoreWriter {
  ...
  public CoreWriter append(String s) {
    b.append(s);
    return this;
  }

//  /** Appends a call to an infix operator. */
//  public CoreWriter infix(int left, AstNode a0, Op op, AstNode a1, int right) {
...
//  public CoreWriter prefix(int left, Op op, AstNode a, int right) {
//    if (left > op.left || op.right < right) {
...
//  public CoreWriter binary(String left, AstNode a0, String mid, AstNode a1,
//      int right) {
//    append(left);
//    a0.unparse(this, 0, 0);
//    append(mid);
...
//  public CoreWriter append(CoreNode node, int left, int right) {
...
//  public CoreWriter appendAll(Iterable<? extends AstNode> nodes, int left, Op op,
//      int right) {
...
//  public CoreWriter appendAll(Iterable<? extends AstNode> list, String sep) {
...
//  public CoreWriter appendAll(Iterable<? extends AstNode> list, String start,
...
//  }
  ...
  public CoreWriter appendLiteral(Comparable value) {
