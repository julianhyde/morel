...
public class Core {
  ...
  public static String toString(CoreNode node) {
    final CoreWriter w = new CoreWriter();
    node.unparse(w, 0, 0);
    return w.toString();
  }
...
//  }
  ...
  public abstract static class Exp extends CoreNode {
    Exp(Op op) {
      super(op);
    }
...
//    }
    ...
    @Override public abstract Exp accept(CoreShuttle shuttle);
...
//  }
  ...
  public static class Literal extends Exp {
    ...
    /** Creates a Literal. */
    Literal(Op op, Comparable value) {
      super(op);
      this.value = requireNonNull(value);
    }
  ...
  public abstract static class Decl extends CoreNode {
    Decl(Op op) {
      super(op);
    }

    @Override public abstract Decl accept(CoreShuttle shuttle);
  }
...
//  }
  ...
  public static class ValDecl extends Decl {
    ...
    ValDecl(ImmutableList<ValBind> valBinds) {
      super(Op.VAL_DECL);
    ...
    public ValDecl accept(CoreShuttle shuttle) {
      return shuttle.visit(this);
    }
...
//  }
  ...
  /** Value bind. */
  public static class ValBind extends CoreNode {
...
//      }
//      RequireNonNull(this.yieldExpOrDefault);
//    }
//
//    public Exp accept(CoreShuttle shuttle) {
//      return shuttle.visit(this);
...
//        java.util.List<FromStep> steps, Core.Exp yieldExp) {
