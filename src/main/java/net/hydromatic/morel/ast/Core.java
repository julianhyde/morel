...
public class Core {
  ...
  public static class From extends Exp {
    ...
    /** Returns whether {@link #yieldExp} is the one that would have been
     * generated by default, that is, what comes out of the last step.
     *
     * <p>Note: Maybe {@code Core.From} should not have a {@code yieldExp},
     * but a new step type, {@code Project}. */
    public boolean hasDefaultYieldExp(TypeSystem typeSystem) {
      final Core.Exp defaultYieldExp =
          core.defaultYieldExp(typeSystem, sources, steps);
      return this.yieldExp.equals(defaultYieldExp);
    }
  }
