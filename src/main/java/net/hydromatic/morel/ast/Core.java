...
public class Core {
   ...
   *
   * <p>TODO: Do we even need OverDecl in core?
   * Didn't we resolve overloads to unique names during type resolution? */
  public static class OverDecl extends Decl {
    ...
    @Override public boolean equals(Object o) {
      return o == this
          || o instanceof OverDecl
          && pat.equals(((OverDecl) o).pat);
    }
    ...
    @Override public OverDecl accept(Shuttle shuttle) {
      return shuttle.visit(this);
    }
