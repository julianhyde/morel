...
public enum BuiltIn {
  ...
  /** Function "Sys.show", aka "show", of type "string &rarr; string". */
  SYS_SHOW("Sys", "show", ts -> ts.fnType(STRING, STRING)),
   ...
   * "extent: (int * bool) bag" returns "bag [(0, false), (0, true), (1, false),
   * (1, true), ...]".
   *
   ...
   */
  Z_EXTENT(
      "$", "extent", ts -> ts.forallType(1, h -> ts.fnType(UNIT, h.list(0)))),
