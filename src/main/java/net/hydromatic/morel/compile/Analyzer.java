...
public class Analyzer extends EnvVisitor {
  ...
  public static Analysis analyze(TypeSystem typeSystem, Environment env,
    ...
    final Map<String, MutableUse> map = new LinkedHashMap<>();
    ...
    if (node instanceof Core.ValDecl) {
      analyzer.use(((Core.ValDecl) node).pat.name).top = true;
    }
  ...
  public static class Analysis {
    public final ImmutableMap<String, Use> map;

    Analysis(ImmutableMap<String, Use> map) {
      this.map = map;
    }
  }
}
