...
public abstract class Codes {
  ...
  private static final Applicable BAG_NULL =
      isEmpty(BuiltIn.BAG_NULL);
  ...
  private static final Applicable BAG_DROP =
      listDrop(BuiltIn.BAG_DROP);

  /** @see BuiltIn#BAG_CONCAT */
  private static final Applicable BAG_CONCAT =
      listConcat(BuiltIn.BAG_CONCAT);

  /** @see BuiltIn#BAG_APP */
  private static final Applicable BAG_APP =
      listApp0(BuiltIn.BAG_APP);

  /** @see BuiltIn#BAG_MAP */
  private static final Applicable BAG_MAP =
      listMap0(BuiltIn.BAG_MAP);
  ...
  private static final Applicable BAG_FILTER =
      listFilter0(BuiltIn.BAG_FILTER);
  ...
  /** Implementation of both {@link Applicable} and {@link Positioned}.
   * Remembers its {@link BuiltIn} so that it can re-position. */
  private abstract static class PositionedApplicableImpl
      extends ApplicableImpl implements Positioned {
