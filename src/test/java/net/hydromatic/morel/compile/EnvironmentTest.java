...
public class EnvironmentTest {
  ...
  @Test void testOptimizeSubEnvironment() {
    final Environment e0 = Environments.empty()
        .bind(core.idPat(PrimitiveType.INT, "a"), 0)
        .bind(core.idPat(PrimitiveType.INT, "b"), 1)
        .bind(core.idPat(PrimitiveType.INT, "c"), 2);
  ...
  private void checkOptimizeSubEnvironment(Environment e0) {
    ...
    final Environment e1 = e0.bind(core.idPat(PrimitiveType.STRING, "true"), "yes");
    ...
    final Environment e2 = e1.bind(core.idPat(PrimitiveType.STRING, "true"), "no");
    assertThat(e2.getValueMap().keySet(), is(nameSet));
    assertThat(e2, hasEnvLength(6));

    // Add "foo". Value count and binding count increase.
    final Environment e3 = e2.bind(core.idPat(PrimitiveType.STRING, "foo"), "baz");
    ...
    final Environment e4 = e3.bind(core.idPat(PrimitiveType.STRING, "true"), "yes");
